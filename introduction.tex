...
%%% Starts with introduction of cloud computing
%%% Add one or two paragraphs about cloud computing before going to scalability
%%% Something like "cloud computing has become a popular issue in recent year" etc.
...
%%% describe target environment: CHT datacenter, heterogeneous
