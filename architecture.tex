...
Despite doing seemingly little work only, it is however the most
critical part of the system, not only because the system acts according
to the plan it makes, but also the flexibility that other frameworks can
