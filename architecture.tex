...
We propose a cloud resource management framework to dynamically adjusts the
number of physical server for a single job.
The framework make decisions according to some specified policies.
The policies takes the remaining workload, priority and deadline of each job
into consideration, and generates a scheduling plan that satisfies the job
requirements.
%%% 
...
%%% change this sentence into work flows, how worker and client interactive with our system
